...
Route::middleware('auth')->group(function(){
    ...
    Route::post('/proposal/approve', [ProposalController::class, 'approve'])->name('approve-proposal');
    ...
    Route::post('/projects/evaluate', [ProjectController::class, 'evaluate'])->name('evaluate-project');
    Route::post('/projects/upload_update', [ProjectUpdateController::class, 'store'])->name('update_project');
    Route::post('/projects/update_evaluation', [ProjectUpdateController::class, 'updateEvaluation'])->name('update_evaluation');
